		...
		<div class="form-header">
			<h4 class="white-text">
				...
				if ( isset( $bp_reg_form_title ) ) {
					...
					esc_html_e( "Creer votre compte", 'sweetdate' );
				} else {
					esc_html_e( "Creer votre compte", 'sweetdate' );
				}
				?>
			...
			<p class="reg-form-details">
				...
				if ( isset( $bp_reg_form_details ) ) {
					...
					//esc_html_e( "Pour inscrire à ce site c'est facile, il suffit de remplir les champs ci-dessous et nous créerons un nouveau compte pour vous en un rien de temps.", 'sweetdate' );
				}
				?>
			</p>
		</div>
